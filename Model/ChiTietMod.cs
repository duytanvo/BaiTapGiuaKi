...
namespace QL_KHACHSAN.Model
{
    class ChiTietMod
    {
        ...
        public DataTable GetData(string ma)
        {
            ...
            cmd.CommandText = @"select ct.MaHD, hh.TenPhong Phong, ct.SoLuong, ct.DonGia, ct.SoLuong*ct.DonGia ThanhTien from tb_CTHD ct, tb_Phong hh where ct.MaPhong = hh.MaPhong and MaHD = '" + ma + "'";
